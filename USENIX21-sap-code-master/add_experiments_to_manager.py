...
if __name__ == "__main__":
    ...
    def_pairs=[('none', ()), ('clrz', (0.999, 0.1)), ('ddr-sse', (400,))]
    #add_hung_all_defs(manager, nkw_list=nkw_list, alpha_list=(0.5,), def_pairs=def_pairs, tt_mode_list=('split_rand_past5-50',), dumb_attack=True)
    #add_hung_all_defs(manager, nkw_list=nkw_list, alpha_list=(0.5,), def_pairs=def_pairs, tt_mode_list=('split_rand_past5-50',), dumb_attack=False)
    #add_hung_vs_basic(manager, [100, 500, 1000, 3000], ['enron_db', 'lucene_db'], [5], alpha_list=[1.0], offset_list=[5], kw_random=True)
    add_hung_all_defs(manager, nkw_list=nkw_list, dataset_list=('enron_db',), alpha_list=(0.5,), def_pairs=def_pairs, tt_mode_list=('split_rand_past5-50',), dumb_attack=True)
    add_hung_all_defs(manager, nkw_list=nkw_list, dataset_list=('enron_db',), alpha_list=(0.5,), def_pairs=def_pairs, tt_mode_list=('split_rand_past5-50',), dumb_attack=False)
    add_hung_vs_basic(manager, [100, 500, 1000, 3000], ['enron_db'], [5], alpha_list=[1.0], offset_list=[5], kw_random=True)
