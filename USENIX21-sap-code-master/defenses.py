...
class Defense:
    ...
    def generate_query_traces(self, kw_id_traces):
        ...
        if self.def_name == 'none':
            ...
            for ctr, kw_id in enumerate(sorted_kw_ids):
                ...
                padded_vols[kw_id] = len(inverted_index[target_kw_id])
            ...
            for kw_id in list(set([kw_id for weekly_kw_trace in kw_id_traces for kw_id in weekly_kw_trace])):
                ...
                padded_volume = padded_vols[kw_id]
                map_kw_id_to_tag_and_volume[kw_id] = (count, padded_volume)
    ...
    def get_dataset_size_for_adversary(self):
        if self.def_name in ('none', 'clrz', 'osse', 'ppyy', 'ddr-sse'):
